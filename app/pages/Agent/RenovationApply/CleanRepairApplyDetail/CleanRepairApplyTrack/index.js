...
export default class CleanRepairApplyTrack extends Component {
  constructor(props) {
    super(props)
  }
  static defaultProps = {
  ...
  renderItem = ({ item, index }) => (
    <View style={styles.detail_container}>
      ...
      <View style={styles.detail_container_body}>
          {index !== (this.props.CleanRepairApplyTrack.length - 1) && <View style={styles.detail_container_body_dashedLine} />}
          {index !== (this.props.CleanRepairApplyTrack.length - 1) && <View style={styles.detail_container_body_dashedLine_cover} />}
    ...
    return (
      <View>
        ...
        <FlatList
          ...
          data={this.props.CleanRepairApplyTrack}
