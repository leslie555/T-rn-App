...
export default class AggPayPage extends Component {
    ...
    fetchData() {
        ...
        // const unPaidAmount = this.props.navigation.getParam('unPaidAmount', '')
        // const totalAmount = this.props.navigation.getParam('totalAmount', '')
        const contractID = this.props.navigation.getParam('contractID', '')
        ...
        if (id) {
            ...
            GetPayCodeBatch({
                bookID: id,
                partAmount: id.length===1?payMoney: 0,
                // W1微信,A1支付宝
    ...
    handleSuccessPay(payType,businessType) {
        ...
        //     case 1:
        //         // 跳转至记账本详情页面
        //         this.props.navigation.replace('AgentAccountDetails', {
        //             id: this.state.billId[0]
        //         })
        //         break;
        // }
    }
