...
const ScrollableTabBar = createReactClass({
  propTypes: {
    ...
    headerRight: PropTypes.element, // 右侧的组件
  ...
  onCancel(text) {
    ...
    this.props.onCancel && this.props.onCancel(text)
  },
  onPress() {
  ...
  render() {
    ...
    return (
      ...
      >
        {!this.props.hideLeft && (
          <TouchableOpacity
            style={headerStyles.defaultHeaderLeft}
        ...
        <View style={headerStyles.defaultHeaderRight}>
...
module.exports = withNavigation(ScrollableTabBar)
